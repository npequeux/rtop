...
impl MemoryMonitor {
    ...
    pub fn update(&mut self) {
        ...
        let mem_percent = (self.system.used_memory() as f64 / self.system.total_memory() as f64 * 100.0) as f32;
    ...
    pub fn get_memory_data(&self) -> (f32, Vec<f32>, u64, u64) {
        let percent = (self.system.used_memory() as f64 / self.system.total_memory() as f64 * 100.0) as f32;
        let history: Vec<f32> = self.mem_history.iter().copied().collect();
        (percent, history, self.system.used_memory(), self.system.total_memory())
    }
    ...
    pub fn get_swap_data(&self) -> (f32, Vec<f32>, u64, u64) {
        ...
        (percent, history, self.system.used_swap(), self.system.total_swap())
    }
}
